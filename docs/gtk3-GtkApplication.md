...
### pony_NOT_IMPLEMENTED_YET_add_accelerator
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L103)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_add_accelerator()
: None val
```
...
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L128)</span>
...
### pony_NOT_IMPLEMENTED_YET_get_accels_for_action
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L150)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_accels_for_action()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_actions_for_accel
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L163)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_actions_for_accel()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_active_window
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L189)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_active_window()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_app_menu
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L206)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_app_menu()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_menu_by_id
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L219)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_menu_by_id()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_menubar
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L233)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_menubar()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_window_by_id
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L246)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_window_by_id()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_get_windows
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L261)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_get_windows()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_inhibit
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L281)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_inhibit()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_is_inhibited
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L311)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_is_inhibited()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_list_action_descriptions
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L323)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_list_action_descriptions()
: None val
```
...
### prefers_app_menu
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L336)</span>
...
### pony_NOT_IMPLEMENTED_YET_remove_accelerator
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L375)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_remove_accelerator()
: None val
```
...
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L385)</span>
...
### pony_NOT_IMPLEMENTED_YET_set_accels_for_action
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L400)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_set_accels_for_action()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_set_app_menu
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L417)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_set_app_menu()
: None val
```
...
### pony_NOT_IMPLEMENTED_YET_set_menubar
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L441)</span>
...
```pony
fun box pony_NOT_IMPLEMENTED_YET_set_menubar()
: None val
```
...
### uninhibit
<span class="source-link">[[Source]](src/gtk3/GtkApplication.md#L466)</span>
